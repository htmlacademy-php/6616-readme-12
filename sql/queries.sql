...
INSERT INTO post (title, content, quote_author, image, video, link, show_count, user_id, content_type_id)
VALUES ('Цитата', 'Мы в жизни любим только раз, а после ищем лишь похожих', 'Джон Доу', '', '', '', 14, 1, 2),
